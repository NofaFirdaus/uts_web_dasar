            ...
            <div class="d-flex align-items-start mt-3 mt-sm-0">
                <div class="flex-shrink-0">
                    <div class="avatar-xl me-3">
                        <img src="upload/no_image.jpg" alt="" class="img-fluid rounded-circle d-block">
                    </div>
                </div>
                <div class="flex-grow-1">
    <div>
        <h5 class="font-size-16 mb-1">hello</h5>
        <p class="text-muted font-size-13">ga@gmail</p>

        <div class="d-flex flex-wrap align-items-start gap-2 gap-lg-3 text-muted font-size-13">
            <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>6821682</div>
            <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>kejoyo</div>
        </div>
    </div>
                </div>
            </div>
    ...
    <div class="col-lg-6">
        <div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" name="email" type="email" value="" id="example-text-input">
            </div>
