...
<div class="card-body">
    ...
    <div>
        ...
        <p class="text-muted font-size-13">world</p>

        <div class="d-flex flex-wrap align-items-start gap-2 gap-lg-3 text-muted font-size-13">
            <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>723712</div>
            <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>kabat</div>
        </div>
    </div>
                </div>
            </div>
